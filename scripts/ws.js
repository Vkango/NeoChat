...
export class WSMessage {
    constructor(wsUri, onmessage_handler) {
        ...
        this.websocket.onopen = function() {
            document.getElementsByClassName("ws-status")[0].innerText = "NeoChat · Online";
    ...
    ProcessWSError(error) {
        document.getElementsByClassName("ws-status")[0].innerText = "NeoChat · Error";
        document.getElementsByClassName("circle-green")[0].id = "circle-red";
        console.error('WebSocket错误:', error);
    };

    process_WS_close() {
        document.getElementsByClassName("ws-status")[0].innerText = "NeoChat · Reconnecting";
        document.getElementsByClassName("circle-green")[0].id = "circle-red";
